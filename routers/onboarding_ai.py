    ...
    try:
        ...
        if is_exact:
            ...
            thinking_instruction = (
                ...
                "1. Что пользователь сказал и что имел в виду?\n"
                "2. Какое настроение — как подстроиться?\n"
                "3. Дал ли данные сверх вопроса — какие?\n"
                "4. Что я уже говорил — не повторяться\n"
                "5. Моя цель сейчас — как к ней привести?\n\n"
                "В response:\n"
                "- Это самостоятельный текст, не продолжение thinking\n"
                "- Начинается с заглавной буквы\n"
                "- Не благодари за ответ, не подтверждай получение данных\n"
                "- Не добавляй вопросы за рамками цели\n"
                "- 1-2 предложения\n\n"
