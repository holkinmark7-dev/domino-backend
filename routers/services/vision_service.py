...
7. ПОРОДА — ВСЕГДА полное официальное название по стандарту FCI/РКФ.
   Не сокращай, не используй разговорные варианты.
   Примеры: "Венгерский муди (Mudi)" не "Муди".
   "Немецкая овчарка (German Shepherd)" не "Овчарка".
   "Сибирский хаски (Siberian Husky)" не "Хаски".
   "Кавказская овчарка (Caucasian Shepherd Dog)" не "Кавказец".
   Формат: "Русское название (Английское название)"."""
